...
class Strawberry_posts_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'strawberry_posts_wigdet', __('Strawberry Taxonomy Posts Widget', 'text_domain'), array('description' => __('Listing posts from selected Taxonomies', 'text_domain'),)
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        echo $this->fetch_template($template, $params);
