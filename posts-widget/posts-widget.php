        ...
        <?php if (function_exists('the_post_thumbnail') && current_theme_supports("post-thumbnails")) : ?>
            ...
            <p>
                <label for="<?php echo $this->get_field_id("exclude_posts"); ?>">
                    <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("exclude_posts"); ?>" name="<?php echo $this->get_field_name("exclude_posts"); ?>" <?php checked(isset($instance['exclude_posts']) ? (bool) $instance['exclude_posts'] : false, true); ?> />
